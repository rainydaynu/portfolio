<template>
  <Layout class="page-project page-illu">
    <SectionHdrShift>
      <g-image alt="Illu logo" src="~/assets/images/logo-illu.svg" />
    </SectionHdrShift>
    <Section class="bric-text">
      <Row>
    ...
    <Section class="bric-tiles">
      <Row>
        <Column class="bric-col-6">
            <g-image alt="Illustration of a cartoon demon" src="~/assets/images/illu-02.png" />
        </Column>
        <Column class="bric-col-6">
            <g-image alt="Illustration of an anthropomorphic rabbit" src="~/assets/images/illu-03.png" />
        </Column>
      </Row>

      <Row>
        <Column class="bric-col-6">
            <g-image alt="Illustration of a nerdy woman" src="~/assets/images/illu-04.png" />
        </Column>
        <Column class="bric-col-6">
            <g-image alt="Illustration of a man posing with two cats plus a leopard gecko and a giant sparkling ant" src="~/assets/images/illu-05.png" />
        </Column>
      </Row>

      <Row>
        <Column>
            <g-image alt="Illustration of red fox and green dinosaur holding Happy Mothers Day sign" src="~/assets/images/illu-06.png" />
        </Column>
      </Row>

      <Row>
        <Column class="bric-col-6">
            <g-image alt="Illustration of an alien with a TV head" src="~/assets/images/illu-07.png" />
        </Column>
        <Column class="bric-col-6">
            <g-image alt="Illustration of an anthropomorphic bird" src="~/assets/images/illu-08.png" />
        </Column>
      </Row>
...
.page-illu .bric-hdr-shift {
  background: url('../assets/images/ban-ill-wrk-01.png');
  background-size: cover;
  background-position: center center;
}

.page-illu .bric-hdr-shift img {
    width: 38%;
    max-width: 340px;
}
...
.page-illu footer .ftr-logo .icon-log {
    margin-right: 7px;
}
